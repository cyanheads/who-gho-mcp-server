...
Thanks for using `who-gho-mcp-server`. Bugs, feature requests, and documentation gaps all belong in an issue — that's where they get read and picked up.

- [Report a bug](https://github.com/cyanheads/who-gho-mcp-server/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/cyanheads/who-gho-mcp-server/issues/new?template=feature_request.yml)
...
`who-gho-mcp-server` is built on [@cyanheads/mcp-ts-core](https://github.com/cyanheads/mcp-ts-core), which handles transports, auth, config, logging, and telemetry. Sorting out which layer broke saves everyone a round-trip:
